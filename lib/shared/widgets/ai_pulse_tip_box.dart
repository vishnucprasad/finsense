...
import 'package:finsense/features/dashboard/view_models/dashboard_provider.dart';
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () =>
                    ref.read(financialTipProvider.notifier).loadTip(),
              ),
            ],
          ),
          ...
          tipState.when(
            data: (tip) => Text(
              tip ??
                  'Tap the refresh icon to scan your recent transactions and get a behavioral tip.',
            ...
            error: (err, _) {
              ...
              if (errStr.contains('quota extended') ||
