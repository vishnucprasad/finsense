...
class _TransactionEntryScreenState
  ...
  void initState() {
    ...
    if (widget.existingTransaction != null) {
      ...
      _selectedAccountId = widget.existingTransaction!.accountId.isNotEmpty
          ? widget.existingTransaction!.accountId
          : null;
      _selectedCategoryId = widget.existingTransaction!.categoryId.isNotEmpty
  ...
  void _saveTransaction() {
    ...
    if (widget.existingTransaction == null) {
      ...
      ref
          .read(transactionNotifierProvider.notifier)
          .editTransaction(transaction, widget.existingTransaction!);
    }
