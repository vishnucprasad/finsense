...
class _EditCategorySheetState extends ConsumerState<EditCategorySheet> {
  ...
  void initState() {
    ...
    if (!_availableIcons.containsKey(_selectedIcon))
      _selectedIcon = 'currency_rupee';
    if (!_availableColors.containsKey(_selectedColor))
      _selectedColor = 'ff10b981';
  }
                ...
                children: _availableIcons.entries.map((entry) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        entry.value,
                        color: isSelected ? AppTheme.cyan : Colors.white54,
                      ),
                    ),
                  );
                }).toList(),
